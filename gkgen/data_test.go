...
type ExampleStruct struct {
	...
	BCP47OrEmptyStringPtr    *string `valid:"NotNil,BCP47OrEmpty"`
	BCP47OrEmptyString       string  `valid:"BCP47OrEmpty"`
	CanBeNilWithConstraints  *string `valid:"Length=(12)"`
	BCP47NonString           int
	BCP47NonStringPtr        *int
	BCP47OrEmptyNonString    int
	BCP47OrEmptyNonStringPtr *int
}
